...
class WorkloadGenerator(QMainWindow):
    ...
    def scen_ui(self):              
        ...
        self.add_scen_dist.addItem("1. Normal")
        self.add_scen_dist.addItem("2. Uniform")
        self.add_scen_dist.addItem("3. Exponential")
        self.add_scen_dist.addItem("4. Spiked")
        ...
        self.generate_wkld_submit = QPushButton("Generate")

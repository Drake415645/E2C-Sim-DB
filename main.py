...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scen_label.setGeometry(QtCore.QRect(480, 30, 181, 16))
        ...
        self.save_wkld.setGeometry(QtCore.QRect(650, 410, 91, 23))
        self.save_wkld.setObjectName("save_wkld")
        self.reset_sim = QtWidgets.QPushButton(self.centralwidget)
        self.reset_sim.setGeometry(QtCore.QRect(650, 440, 91, 23))
        ...
        self.scen_path.setReadOnly(True)
        self.wl_generate.setEnabled(False)
        self.scen_load.clicked.connect(self.load_scen)
        self.reset_sim.clicked.connect(self.reset)
    ...
    def reset(self):
        ...
        #Delete wkld from gui
        for _ in range(int(self.amount)):
            self.tabWidget.removeTab(0)

        self.dist_combo.setEnabled(True)
        self.num_tasks.setEnabled(True)
        self.starting_time.setEnabled(True)
        self.ending_time.setEnabled(True)
        self.scen_task_id.setEnabled(True)
        self.add_scen_btn.setEnabled(True)
        self.wl_generate.setEnabled(False)
        self.wl_amount.setEnabled(True)
        self.scen_load.setEnabled(True)
    ...
    def add_scen(self):
        ...
        self.wl_generate.setEnabled(True)
    ...
    def generate(self):
        ...
        for k in range(int(self.amount)):
            ...
            for i in range(self.length):
                ...
                self.wk_table.setItem(i,1, QtWidgets.QTableWidgetItem(str(self.wk_task_id)[1]))
            ...
            self.num_tasks.setEnabled(False)
            self.starting_time.setEnabled(False)
            self.ending_time.setEnabled(False)
            self.scen_task_id.setEnabled(False)
            self.wl_generate.setEnabled(False)
            self.add_scen_btn.setEnabled(False)
            self.wl_amount.setEnabled(False)
            self.scen_load.setEnabled(False)
